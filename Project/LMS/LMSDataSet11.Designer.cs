...
namespace LMS {
    ...
    public partial class LMSDataSet1 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/LMSDataSet11.xsd";
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public BooksRow AddBooksRow(int bookID, string book_name) {
...
namespace LMS.LMSDataSet1TableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Books] WHERE (([bookID] = @Original_bookID) AND ((@IsNull_book" +
                "_name = 1 AND [book_name] IS NULL) OR ([book_name] = @Original_book_name)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Books] ([bookID], [book_name]) VALUES (@bookID, @book_name);\r\n" +
                "SELECT bookID, book_name FROM Books WHERE (bookID = @bookID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Books] SET [bookID] = @bookID, [book_name] = @book_name WHERE (([bookID] = @Original_bookID) AND ((@IsNull_book_name = 1 AND [book_name] IS NULL) OR ([book_name] = @Original_book_name)));
SELECT bookID, book_name FROM Books WHERE (bookID = @bookID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT bookID, book_name FROM dbo.Books";
        ...
        public virtual int Delete(int Original_bookID, string Original_book_name) {
        ...
        public virtual int Insert(int bookID, string book_name) {
        ...
        public virtual int Update(int bookID, string book_name, int Original_bookID, string Original_book_name) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string book_name, int Original_bookID, string Original_book_name) {
            return this.Update(Original_bookID, book_name, Original_bookID, Original_book_name);
        }
    }
