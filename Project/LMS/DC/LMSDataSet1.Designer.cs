...
namespace LMS.DC.LMSDataSet1TableAdapters {
    ...
    public partial class memberTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[member] ([mid], [Name]) VALUES (@mid, @Name);\r\nSELECT mid, Nam" +
                "e FROM member WHERE (mid = @mid)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[member] SET [mid] = @mid, [Name] = @Name WHERE (([mid] = @Original_" +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT mid, Name FROM dbo.member";
        ...
        public virtual int Fill(LMSDataSet1.memberDataTable dataTable) {
        ...
        public virtual LMSDataSet1.memberDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LMSDataSet1.memberDataTable dataTable = new LMSDataSet1.memberDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LMSDataSet1.memberDataTable dataTable) {
        ...
        public virtual int Insert(int mid, string Name) {
        ...
        public virtual int Update(int mid, string Name, int Original_mid) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, int Original_mid) {
            return this.Update(Original_mid, Name, Original_mid);
        }
    }
